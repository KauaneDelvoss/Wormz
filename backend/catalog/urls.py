...
from core.views import UserViewSet, BookViewSet, BookshelfViewSet, GenreViewSet, OwnViewSet, TypeViewSet, WritesViewSet,  cadastro,  getUser, updateUser, deleteUser
